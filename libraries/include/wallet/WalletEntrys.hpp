...
namespace goopal { namespace wallet {
   ...
   struct AccountData : public goopal::blockchain::AccountEntry
   {
...
FC_REFLECT_ENUM( goopal::wallet::WalletEntryTypeEnum,
...
FC_REFLECT_ENUM( goopal::wallet::PropertyEnum,
        (version)
        (next_entry_number)
        (next_child_key_index)
        (automatic_backups)
...
FC_REFLECT( goopal::wallet::KeyData,
        (account_address)
        (public_key)
...
FC_REFLECT_ENUM( goopal::wallet::ContactData::ContactTypeEnum,
        (account_name)
        (public_key)
        (address)
        (btc_address)
...
FC_REFLECT( goopal::wallet::ContactData,
        (contact_type)
        (data)
        (label)
        (favorite)
...
FC_REFLECT( goopal::wallet::TransactionData,
        (entry_id)
        (block_num)
        (is_virtual)
        (is_confirmed)
...
FC_REFLECT( goopal::wallet::LedgerEntry,
        (from_account)
        (to_account)
        (amount)
        (memo)
...
FC_REFLECT( goopal::wallet::TransactionLedgerEntry,
        (id)
        (block_num)
        (block_id)
        (timestamp)
...
FC_REFLECT_DERIVED( goopal::wallet::PrettyTransactionExperimental, (goopal::wallet::TransactionLedgerEntry),
        (inputs)
        (outputs)
        (balances)
        (notes)
...
FC_REFLECT( goopal::wallet::Setting,
        (name)
        (value)
        )

FC_REFLECT( goopal::wallet::GenericWalletEntry,
        (type)
        (data)
        )
...
namespace fc {
   ...
   template<typename T, goopal::wallet::WalletEntryTypeEnum N>
   struct get_typename< goopal::wallet::WalletEntry<T,N> >
   {
   ...
   template<typename Type, goopal::wallet::WalletEntryTypeEnum N>
   struct reflector<goopal::wallet::WalletEntry<Type,N>>
   {
      typedef goopal::wallet::WalletEntry<Type,N>  type;
      ...
      {
          {
            typedef decltype(((goopal::wallet::BaseEntry<N>*)nullptr)->wallet_entry_index) member_type;
            visitor.TEMPLATE operator()<member_type,goopal::wallet::BaseEntry<N>,&goopal::wallet::BaseEntry<N>::wallet_entry_index>( "index" );
          }
