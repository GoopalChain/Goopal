...
namespace goopal { namespace wallet {
   ...
   class WalletDb
   {
      public:
         ...
         void                   store_account( const AccountData& account );
         void                   store_account( const blockchain::AccountEntry& blockchain_account_entry );
      ...
      private:
         ...
         unordered_map<Address, Address>                                btc_to_gop_address;
