   ...
   class Wallet
   {
      public:
        ...
        * @return WalletTransactionEntry
         ...
         * @return void
         */
		 void accountsplit(const string & original, string & to_account, string & sub_account);
         /**
         ...
         *
         * @param wif_key A private key in goopal wallet import format
         ...
         * @return void
         */
         void cache_transaction( WalletTransactionEntry& transaction_entry );
         ...
         * @param amount_to_transfer_symbol the asset to transfer like GOP 
         ...
         * @param gop_account centralized system address
         *
         * @return WalletTransactionEntry
         */
         ...
         */
         WalletTransactionEntry register_account(
                 ...
                 goopal::blockchain::AccountType new_account_type,
                 bool sign
                 );
         /**  
...
FC_REFLECT_ENUM( goopal::wallet::AccountKeyType,
        (owner_key)
        (active_key)
        (signing_key)
        )
