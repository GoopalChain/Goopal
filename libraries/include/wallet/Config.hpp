...
#define GOP_WALLET_DEFAULT_UNLOCK_TIME_SEC                  ( 60 * 60 )

#define GOP_WALLET_DEFAULT_TRANSACTION_FEE                  1000 // XTS

#define GOP_WALLET_DEFAULT_TRANSACTION_EXPIRATION_SEC       ( 60 * 60 )
