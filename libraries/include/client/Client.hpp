...
//    using goopal::mail::mail_client_ptr;
//    using goopal::mail::mail_server_ptr;
    ...
    struct Config
    {
        ...
        uint16_t            maximum_number_of_connections = GOP_NET_DEFAULT_MAX_CONNECTIONS;
        bool                use_upnp = true;
        ...
        ShareType          min_relay_fee = GOP_BLOCKCHAIN_DEFAULT_RELAY_FEE;
        string              wallet_callback_url;

        ShareType          light_network_fee = GOP_BLOCKCHAIN_DEFAULT_RELAY_FEE;
        ShareType          light_relay_fee = GOP_BLOCKCHAIN_DEFAULT_RELAY_FEE;
        ...
        optional<string>    growl_gop_client_identifier;
     ...
     *
     */
    class Client : public goopal::rpc_stubs::CommonApiClient,
...
//         mail_server_ptr            get_mail_server()const;
         goopal::rpc::RpcServerPtr   get_rpc_server()const;
         goopal::net::NodePtr         get_node()const;
         fc::path                   get_data_dir()const;

         // returns true if the client is connected to the network
         bool                is_connected() const;
         goopal::net::NodeIdType get_node_id() const;
         ...
         bool handle_message(const goopal::net::Message&, bool sync_mode);
         void sync_status(uint32_t item_type, uint32_t item_count);

       protected:
         virtual goopal::api::CommonApi* get_impl() const override;
...
extern const std::string GOP_MESSAGE_MAGIC;

FC_REFLECT(goopal::client::ClientNotification, (timestamp)(message)(signature) )
FC_REFLECT( goopal::client::RpcServerConfig, (enable)(enable_cache)(rpc_user)(rpc_password)(rpc_endpoint)(httpd_endpoint)
            (encrypted_rpc_endpoint)(encrypted_rpc_wif_key)(htdocs) )
FC_REFLECT( goopal::client::ChainServerConfig, (enabled)(listen_port) )
FC_REFLECT( goopal::client::Config,
        (logging)
        (ignore_console)
        (client_debug_name)
        (rpc)
