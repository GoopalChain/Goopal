...
{
public:
   typedef goopal::db::LevelMap<fc::time_point,fc::exception> ExceptionLeveldbType;
private:
...
public:
   void open(const fc::path& filename)
   {
      ...
      catch (const goopal::db::level_map_open_failure&)
      {
...
class ClientImpl : public goopal::net::NodeDelegate,
      public goopal::api::CommonApi
{
public:
   ...
   ClientImpl(goopal::client::Client* self, const std::string& user_agent) :
      _self(self),
      ...
      _blockchain_synopsis_size_limit((unsigned)(log2(GOP_BLOCKCHAIN_BLOCKS_PER_YEAR * 20))),
   ...
   */
   ...
   // @{
   virtual bool has_item(const goopal::net::ItemId& id) override;
   virtual bool handle_message(const goopal::net::Message&, bool sync_mode) override;
   virtual std::vector<goopal::net::ItemHashType> get_item_ids(uint32_t item_type,
                                                           const vector<goopal::net::ItemHashType>& blockchain_synopsis,
                                                           uint32_t& remaining_item_count,
                                                           uint32_t limit = 2000) override;
   virtual goopal::net::Message get_item(const goopal::net::ItemId& id) override;
   virtual fc::sha256 get_chain_id() const override
   {
      FC_ASSERT( _chain_db != nullptr );
      return _chain_db->get_chain_id();
   }
   virtual std::vector<goopal::net::ItemHashType> get_blockchain_synopsis(uint32_t item_type,
   ...
   virtual uint32_t get_block_number(const goopal::net::ItemHashType& block_id) override;
   virtual fc::time_point_sec get_block_time(const goopal::net::ItemHashType& block_id) override;
   virtual fc::time_point_sec get_blockchain_now() override;
   virtual goopal::net::ItemHashType get_head_block_id() const override;
   ...
   goopal::client::Client*                                    _self;
   std::string                                             _user_agent;
   goopal::cli::Cli*                                          _cli = nullptr;
   ...
   goopal::rpc::RpcServerPtr                                _rpc_server = nullptr;
   std::unique_ptr<goopal::net::ChainServer>                 _chain_server = nullptr;
   std::unique_ptr<goopal::net::UpnpService>                 _upnp_service = nullptr;
 ...
 //  std::shared_ptr<goopal::mail::server>                      _mail_server = nullptr;
  // std::shared_ptr<goopal::mail::client>                      _mail_client = nullptr;
   ...
   goopal::net::NodePtr                                      _p2p_node = nullptr;
   bool                                                    _simulated_network = false;

   GopGntpNotifierPtr                                   _notifier;
   ...
   // include all of the method overrides generated by the gop_api_generator
