...
namespace goopal { namespace rpc_stubs {
  ...
  class CommonApiRpcClient : public goopal::api::CommonApi
  {
  public:
    ...
    std::vector<std::pair<goopal::blockchain::TransactionIdType, goopal::blockchain::SignedTransaction>> blockchain_list_pending_transactions() const override;
    ...
    goopal::wallet::PrettyTransaction blockchain_get_pretty_transaction(const std::string& transaction_id_prefix, bool exact = fc::json::from_string("false").as<bool>()) const override;
    ...
    std::string blockchain_export_fork_graph(uint32_t start_block = fc::json::from_string("1").as<uint32_t>(), uint32_t end_block = fc::json::from_string("-1").as<uint32_t>(), const goopal::blockchain::FilePath& filename = fc::json::from_string("\"\"").as<goopal::blockchain::FilePath>()) const override;
    ...
    std::map<goopal::blockchain::TransactionIdType, fc::exception> wallet_get_pending_transaction_errors(const goopal::blockchain::FilePath& filename = fc::json::from_string("\"\"").as<goopal::blockchain::FilePath>()) const override;
    ...
    goopal::blockchain::Address wallet_account_create(const std::string& account_name, const fc::variant& private_data = fc::json::from_string("null").as<fc::variant>()) override;
    ...
    std::vector<goopal::blockchain::AccountEntry> wallet_get_all_approved_accounts(int8_t approval = fc::json::from_string("1").as<int8_t>()) override;
    ...
    goopal::wallet::WalletTransactionEntry wallet_transfer_to_address(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_address, const goopal::blockchain::Imessage& memo_message = fc::json::from_string("\"\"").as<goopal::blockchain::Imessage>(), const goopal::wallet::VoteStrategy& strategy = fc::json::from_string("\"vote_recommended\"").as<goopal::wallet::VoteStrategy>()) override;
    goopal::wallet::WalletTransactionEntry wallet_transfer_to_public_account(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_account_name, const goopal::blockchain::Imessage& memo_message = fc::json::from_string("\"\"").as<goopal::blockchain::Imessage>(), const goopal::wallet::VoteStrategy& strategy = fc::json::from_string("\"vote_recommended\"").as<goopal::wallet::VoteStrategy>()) override;
    ...
    std::vector<goopal::wallet::AccountAddressData> wallet_list_my_addresses() const override;
    ...
    goopal::wallet::WalletTransactionEntry wallet_asset_create(const std::string& symbol, const std::string& asset_name, const std::string& issuer_name, const std::string& description, const std::string& maximum_share_supply, uint64_t precision, const fc::variant& public_data = fc::json::from_string("null").as<fc::variant>(), bool is_market_issued = fc::json::from_string("false").as<bool>()) override;
    goopal::wallet::WalletTransactionEntry wallet_asset_issue(const std::string& amount, const std::string& symbol, const std::string& to_account_name, const goopal::blockchain::Imessage& memo_message = fc::json::from_string("\"\"").as<goopal::blockchain::Imessage>()) override;
    ...
    goopal::wallet::WalletTransactionEntry wallet_delegate_withdraw_pay(const std::string& delegate_name, const std::string& to_account_name, const std::string& amount_to_withdraw) override;
    goopal::blockchain::DelegatePaySalary wallet_delegate_pay_balance_query(const std::string& delegate_name) override;
    std::map<std::string,goopal::blockchain::DelegatePaySalary> wallet_active_delegate_salary() override;
    ...
    goopal::blockchain::Asset wallet_set_transaction_fee(const std::string& fee) override;
