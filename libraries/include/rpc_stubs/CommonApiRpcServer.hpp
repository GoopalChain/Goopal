...
namespace goopal { namespace rpc_stubs {
  ...
  {
  public:
    virtual goopal::api::CommonApi* get_client() const = 0;
    ...
    virtual void store_method_metadata(const goopal::api::MethodData& method_metadata) = 0;
    ...
    fc::variant blockchain_get_gop_account_balance_entry_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
    fc::variant blockchain_get_gop_account_balance_entry_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
