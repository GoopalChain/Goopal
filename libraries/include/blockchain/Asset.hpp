...
namespace goopal { namespace blockchain {
  ...
  struct Price
  {
      ...
      fc::uint128_t ratio; // This is a DECIMAL FRACTION with denominator equal to GOP_PRICE_PRECISION
...
FC_REFLECT( goopal::blockchain::Price, (ratio)(quote_asset_id)(base_asset_id) );
FC_REFLECT( goopal::blockchain::Asset, (amount)(asset_id) );
