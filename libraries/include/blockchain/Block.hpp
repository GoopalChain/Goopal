...
FC_REFLECT( goopal::blockchain::BlockHeader,
            (previous)(block_num)(timestamp)(transaction_digest)(next_secret_hash)(previous_secret) )
FC_REFLECT_DERIVED( goopal::blockchain::SignedBlockHeader, (goopal::blockchain::BlockHeader), (delegate_signature) )
FC_REFLECT_DERIVED( goopal::blockchain::FullBlock, (goopal::blockchain::SignedBlockHeader), (user_transactions) )
FC_REFLECT_DERIVED( goopal::blockchain::DigestBlock, (goopal::blockchain::SignedBlockHeader), (user_transaction_ids) )
