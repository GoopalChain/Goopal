...
struct VoteDel
{
   ...
   VoteDel( int64_t v = 0, AccountIdType del = 0 )
...
FC_REFLECT( goopal::blockchain::MultisigMetaInfo,
            (required)
            (owners)
            )
FC_REFLECT( goopal::blockchain::AccountMetaInfo,
            (type)
            (data)
            )
FC_REFLECT( goopal::blockchain::DelegateStats,
            (votes_for)
            (pay_rate)
            (signing_key_history)
...
FC_REFLECT( goopal::blockchain::VoteDel,
            (votes)
            (delegate_id)
            )
FC_REFLECT( goopal::blockchain::AccountEntry,
            (id)
            (name)
            (public_data)
            (owner_key)
