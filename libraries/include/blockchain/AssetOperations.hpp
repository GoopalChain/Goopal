...
FC_REFLECT( goopal::blockchain::CreateAssetOperation,
            (symbol)
            (name)
            (description)
            (public_data)
...
FC_REFLECT( goopal::blockchain::UpdateAssetOperation,
            (asset_id)
            (name)
            (description)
            (public_data)
...
FC_REFLECT_DERIVED( goopal::blockchain::UpdateAssetExtOperation, 
                    (goopal::blockchain::UpdateAssetOperation),
                    (flags)
                    (issuer_permissions)
                    (issuer_account_id)
                    (transaction_fee)
...
FC_REFLECT( goopal::blockchain::IssueAssetOperation,
            (amount)
            )
