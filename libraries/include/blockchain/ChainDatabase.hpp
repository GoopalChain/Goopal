   ...
   class ChainDatabase : public ChainInterface, public std::enable_shared_from_this<ChainDatabase>
   {
      public:
         ...
         */
         ...
         /**  Fetch GOP input balance in blocks that block_num of them are lower of the given block_num 
         *  or equal to 
         *
         * @param  block_num  uint32_t
         *
         * @return vector<GopTrxidBalance>
         */
		 vector<GopTrxidBalance> fetch_gop_input_balance(const uint32_t &  block_num);

         /**  Insert the GOP transaction balance to db _gop_input_balance_entry
         *
         * @param  gop_account  string
         * @param  gop_balance_entry  GopTrxidBalance
         *
         * @return void
         */
		 void transaction_insert_to_gop_balance(const string & gop_account, const GopTrxidBalance & gop_balance_entry);

         /** Erase the GOP transaction balance from db _gop_input_balance_entry 
         *
         * @param  gop_account  string
         * @param  gop_balance_entry  GopTrxidBalance
         *
         ...
         */
		 ...
		 //Must handle account before you use this function
		 void transaction_erase_from_gop_full_entry(const string& gop_accout, const GopTrxidBalance& gop_balance_entry);
         ...
         */
         SignedBlockHeader         get_block_header( const BlockIdType& )const;
         ...
         */
         virtual TransactionEvaluationStatePtr   evaluate_transaction( const SignedTransaction& trx, const ShareType required_fees = 0 );
...
FC_REFLECT( goopal::blockchain::BlockForkData, (next_blocks)(is_linked)(is_valid)(invalid_reason)(is_included)(is_known) )
FC_REFLECT( goopal::blockchain::ForkEntry, (block_id)(signing_delegate)(transaction_count)(latency)(size)(timestamp)(is_valid)(invalid_reason)(is_current_fork) )
