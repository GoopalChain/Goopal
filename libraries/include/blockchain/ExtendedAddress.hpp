...
FC_REFLECT( goopal::blockchain::ExtendedPublicKey, (pub_key)(chain_code) )
FC_REFLECT( goopal::blockchain::ExtendedPrivateKey, (priv_key)(chain_code) )
FC_REFLECT( goopal::blockchain::ExtendedAddress, (addr) )

namespace fc
{
   void to_variant( const goopal::blockchain::ExtendedAddress& var,  fc::variant& vo );
   void from_variant( const fc::variant& var,  goopal::blockchain::ExtendedAddress& vo );
}

namespace std
{
   template<>
   struct hash<goopal::blockchain::ExtendedAddress>
   {
       public:
         size_t operator()(const goopal::blockchain::ExtendedAddress &a) const
         {
            size_t s;
            fc::sha1::encoder enc;
            fc::raw::pack( enc, a );
