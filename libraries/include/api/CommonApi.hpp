...
namespace goopal { namespace api {
  ...
  public:
    ...
    /**
     * fetch all GopTrxidBalance from block where blocknum of the block lower than block_num or equal to block_num.
     *
     * @param block_num (uint32_t, required)
     *
     * @return vector<gop_trxid_balance>
     */
    virtual std::vector<goopal::blockchain::GopTrxidBalance> blockchain_get_gop_account_balance_entry(uint32_t block_num) = 0;
    /**
     ...
     * @return asset
     */
    virtual goopal::blockchain::Asset blockchain_calculate_supply(const std::string& asset) const = 0;
    /**
     ...
     */
    virtual goopal::blockchain::BlockchainSecurityState blockchain_get_security_state() const = 0;
    /**
     ...
     */
    virtual std::vector<goopal::blockchain::AccountEntry> blockchain_list_accounts(const std::string& first_account_name = fc::json::from_string("\"\"").as<std::string>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) const = 0;
    /**
     * Returns a list of recently updated accounts.
     *
     * @return account_entry_array
     */
    virtual std::vector<goopal::blockchain::AccountEntry> blockchain_list_recently_updated_accounts() const = 0;
    /**
     * Returns a list of recently registered accounts.
     *
     * @return account_entry_array
     */
    virtual std::vector<goopal::blockchain::AccountEntry> blockchain_list_recently_registered_accounts() const = 0;
    /**
     ...
     */
    virtual std::vector<goopal::blockchain::AssetEntry> blockchain_list_assets(const std::string& first_symbol = fc::json::from_string("\"\"").as<std::string>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) const = 0;
    /**
     ...
     * @return oblock_entry
     */
    virtual fc::optional<goopal::blockchain::BlockEntry> blockchain_get_block(const std::string& block) const = 0;
    /**
     ...
     */
    virtual std::map<goopal::blockchain::TransactionIdType, goopal::blockchain::TransactionEntry> blockchain_get_block_transactions(const std::string& block) const = 0;
    /**
     ...
     */
    virtual fc::optional<goopal::blockchain::AccountEntry> blockchain_get_account(const std::string& account) const = 0;
    /**
     ...
     */
    virtual std::map<goopal::blockchain::AccountIdType, std::string> blockchain_get_slate(const std::string& slate) const = 0;
    /**
     ...
     */
    virtual goopal::blockchain::BalanceEntry blockchain_get_balance(const goopal::blockchain::Address& balance_id) const = 0;
    /**
     ...
     */
    virtual std::unordered_map<goopal::blockchain::BalanceIdType, goopal::blockchain::BalanceEntry> blockchain_list_balances(const std::string& first_balance_id = fc::json::from_string("\"\"").as<std::string>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) const = 0;
    /**
     ...
     * @return balance_entry_map
     */
    virtual std::unordered_map<goopal::blockchain::BalanceIdType, goopal::blockchain::BalanceEntry> blockchain_list_address_balances(const std::string& addr, const fc::time_point& chanced_since = fc::json::from_string("\"1970-1-1T00:00:01\"").as<fc::time_point>()) const = 0;
    /**
     ...
     */
    virtual goopal::wallet::AccountBalanceSummaryType blockchain_get_account_public_balance(const std::string& account_name) const = 0;
    /**
     ...
     * @return balance_entry_map
     */
    virtual std::unordered_map<goopal::blockchain::BalanceIdType, goopal::blockchain::BalanceEntry> blockchain_list_key_balances(const goopal::blockchain::PublicKeyType& key) const = 0;
    /**
     ...
     */
    virtual fc::optional<goopal::blockchain::AssetEntry> blockchain_get_asset(const std::string& asset) const = 0;
    /**
     ...
     * @return account_entry_array
     */
    virtual std::vector<goopal::blockchain::AccountEntry> blockchain_list_active_delegates(uint32_t first = fc::json::from_string("0").as<uint32_t>(), uint32_t count = fc::json::from_string("20").as<uint32_t>()) const = 0;
    /**
     ...
     * @return account_entry_array
     */
    virtual std::vector<goopal::blockchain::AccountEntry> blockchain_list_delegates(uint32_t first = fc::json::from_string("0").as<uint32_t>(), uint32_t count = fc::json::from_string("20").as<uint32_t>()) const = 0;
    /**
     ...
     */
    virtual std::vector<goopal::blockchain::BlockEntry> blockchain_list_blocks(uint32_t max_block_num = fc::json::from_string("-1").as<uint32_t>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) = 0;
    /**
     ...
     */
    virtual std::map<uint32_t, std::vector<goopal::blockchain::ForkEntry>> blockchain_list_forks() const = 0;
    /**
     ...
     */
    virtual std::vector<goopal::blockchain::SlotEntry> blockchain_get_delegate_slot_entrys(const std::string& delegate_name, uint32_t limit = fc::json::from_string("\"10\"").as<uint32_t>()) const = 0;
    /**
     ...
     * @return asset
     */
    virtual goopal::blockchain::Asset blockchain_unclaimed_genesis() const = 0;
    /**
     ...
     */
    virtual void blockchain_broadcast_transaction(const goopal::blockchain::SignedTransaction& trx) = 0;
    /**
     * Convert bitcoin address file to goopal address file.
     *
     ...
     */
    virtual goopal::blockchain::TransactionIdType network_broadcast_transaction(const goopal::blockchain::SignedTransaction& transaction_to_broadcast) = 0;
    /**
     ...
     */
    virtual goopal::net::MessagePropagationData network_get_transaction_propagation_data(const goopal::blockchain::TransactionIdType& transaction_id) = 0;
    /**
     ...
     * @return message_propagation_data
     */
    virtual goopal::net::MessagePropagationData network_get_block_propagation_data(const goopal::blockchain::BlockIdType& block_hash) = 0;
    /**
     ...
     */
    virtual std::vector<goopal::net::PotentialPeerEntry> network_list_potential_peers() const = 0;
    /**
     ...
     */
    virtual void delegate_blacklist_add_transaction(const goopal::blockchain::TransactionIdType& id) = 0;
    /**
     * Remove specified transaction from blacklist.
     *
     * @param id transaction to remove from blacklist (transaction_id, required)
     */
    virtual void delegate_blacklist_remove_transaction(const goopal::blockchain::TransactionIdType& id) = 0;
    /**
     * Add specified operation to blacklist.
     *
     * @param id operation to add to blacklist (operation_type, required)
     */
    virtual void delegate_blacklist_add_operation(const goopal::blockchain::OperationTypeEnum& id) = 0;
    /**
     * Remove specified operation from blacklist.
     *
     * @param id operation to remove from blacklist (operation_type, required)
     */
    virtual void delegate_blacklist_remove_operation(const goopal::blockchain::OperationTypeEnum& id) = 0;
    /**
     ...
     */
    virtual std::vector<goopal::wallet::PrettyTransaction> wallet_account_transaction_history(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>(), const std::string& asset_symbol = fc::json::from_string("\"\"").as<std::string>(), int32_t limit = fc::json::from_string("0").as<int32_t>(), uint32_t start_block_num = fc::json::from_string("0").as<uint32_t>(), uint32_t end_block_num = fc::json::from_string("-1").as<uint32_t>()) const = 0;
    /**
     * Lists transaction history for the specified account.
     *
     * @param account_name the name of the account for which the transaction history will be returned, "" for all
     ...
     * @return pretty_transactions
     */
    virtual std::vector<goopal::wallet::PrettyTransaction> wallet_transaction_history_splite(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>(), const std::string& asset_symbol = fc::json::from_string("\"\"").as<std::string>(), int32_t limit = fc::json::from_string("0").as<int32_t>(), int32_t transaction_type = fc::json::from_string("\"2\"").as<int32_t>()) const = 0;
    /**
     ...
     * @return account_balance_summary_type
     */
    virtual goopal::wallet::AccountBalanceSummaryType wallet_account_historic_balance(const fc::time_point& time, const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
    /**
     ...
     *
     * @param address the address/accountname to be checking (string, required)
     *
     * @return bool
     */
     ...
     * @return transaction_entry
     */
    virtual goopal::wallet::WalletTransactionEntry wallet_get_transaction(const std::string& transaction_id) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual goopal::wallet::WalletTransactionEntry wallet_scan_transaction(const std::string& transaction_id, bool overwrite_existing = fc::json::from_string("false").as<bool>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual goopal::wallet::WalletTransactionEntry wallet_account_update_registration(const std::string& account_name, const std::string& pay_from_account, const fc::variant& public_data = fc::json::from_string("null").as<fc::variant>(), uint8_t delegate_pay_rate = fc::json::from_string("-1").as<uint8_t>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual goopal::wallet::WalletTransactionEntry wallet_account_update_active_key(const std::string& account_to_update, const std::string& pay_from_account, const std::string& new_active_key = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     * Lists all accounts associated with this wallet.
     *
     * @return wallet_account_entry_array
     */
    virtual std::vector<goopal::wallet::WalletAccountEntry> wallet_list_accounts() const = 0;
    /**
     * Lists all unregistered accounts belonging to this wallet.
     *
     * @return wallet_account_entry_array
     */
    virtual std::vector<goopal::wallet::WalletAccountEntry> wallet_list_unregistered_accounts() const = 0;
    /**
     ...
     */
    virtual goopal::wallet::WalletAccountEntry wallet_get_account(const std::string& account_name) const = 0;
    /**
     * Get the account entry for a given name.
     *
     * @param account_name the name of the account whose public address you want (account_name, required)
     ...
     * @return transaction_entry
     */
    virtual goopal::wallet::WalletTransactionEntry wallet_asset_issue_to_addresses(const std::string& symbol, const std::map<std::string, goopal::blockchain::ShareType>& addresses) = 0;
    /**
     ...
     * @return account_balance_summary_type
     */
    virtual goopal::wallet::AccountBalanceSummaryType wallet_account_balance(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
    /**
     ...
     */
    virtual goopal::wallet::AccountBalanceIdSummaryType wallet_account_balance_ids(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
    /**
     ...
     */
    virtual std::vector<goopal::wallet::PublicKeySummary> wallet_account_list_public_keys(const std::string& account_name) = 0;
    /**
     ...
     * @return asset
     */
    virtual goopal::blockchain::Asset wallet_get_transaction_fee(const std::string& symbol = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     ...
     * @return optional_string
     */
    virtual fc::optional<std::string> wallet_dump_account_private_key(const std::string& account_name, const goopal::wallet::AccountKeyType& key_type) const = 0;
    /**
     ...
     */
    virtual goopal::wallet::AccountVoteSummaryType wallet_account_vote_summary(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
    /**
     ...
     * @return vote_summary
     */
    virtual goopal::wallet::VoteSummary wallet_check_vote_status(const std::string& account) = 0;
    /**
    ...
    /**
     * Initiates the login procedure by providing a Gop Login URL.
     *
     ...
     * @return variant
     */
    virtual fc::variant wallet_login_finish(const goopal::blockchain::PublicKeyType& server_key, const goopal::blockchain::PublicKeyType& client_key, const fc::ecc::compact_signature& client_signature) = 0;
    /**
     ...
     * @return transaction_builder
     */
    virtual goopal::wallet::TransactionBuilder wallet_balance_set_vote_info(const goopal::blockchain::Address& balance_id, const std::string& voter_address = fc::json::from_string("\"\"").as<std::string>(), const goopal::wallet::VoteStrategy& strategy = fc::json::from_string("\"vote_all\"").as<goopal::wallet::VoteStrategy>(), bool sign_and_broadcast = fc::json::from_string("\"true\"").as<bool>(), const std::string& builder_path = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual goopal::wallet::WalletTransactionEntry wallet_publish_slate(const std::string& publishing_account_name, const std::string& paying_account_name = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual goopal::wallet::WalletTransactionEntry wallet_publish_version(const std::string& publishing_account_name, const std::string& paying_account_name = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual goopal::wallet::WalletTransactionEntry wallet_collect_genesis_balances(const std::string& account_name) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual goopal::wallet::WalletTransactionEntry wallet_account_retract(const std::string& account_to_retract, const std::string& pay_from_account) = 0;
    /**
    ...
    /**
     * Return information about given Gop address.
     *
     ...
     * @return transaction_entry
     */
    virtual goopal::wallet::WalletTransactionEntry builder_finalize_and_sign(const goopal::wallet::TransactionBuilder& builder) const = 0;
    /**
     * Returns help information as JSON data.
     *
     * @return method_map_type
     */
    virtual std::map<std::string, goopal::api::MethodData> meta_help() const = 0;
    /**
