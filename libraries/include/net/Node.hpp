  ...
  struct MessagePropagationData
  {
   ...
   class NodeDelegate
   {
      public:
          ...
          */
         virtual std::vector<ItemHashType> get_blockchain_synopsis(uint32_t item_type, const goopal::net::ItemHashType& reference_point = goopal::net::ItemHashType(), uint32_t number_of_blocks_after_reference_point = 0) = 0;
...
FC_REFLECT(goopal::net::MessagePropagationData, (received_time)(validated_time)(originating_peer));
