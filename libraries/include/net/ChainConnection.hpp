...
namespace goopal { namespace net {
   ...
   class ChainConnection : public std::enable_shared_from_this<ChainConnection>
   {
      public:
        ...
        goopal::blockchain::BlockIdType get_last_block_id()const;
        void                           set_last_block_id( const goopal::blockchain::BlockIdType& t );

        void exec_sync_loop();
        void set_database( goopal::blockchain::ChainDatabase*  );
