...
TimeDiscontinuitySignalType time_discontinuity_signal;
...
{
   return timestamp.sec_since_epoch() / GOP_BLOCKCHAIN_BLOCK_INTERVAL_SEC;
}

fc::time_point_sec get_slot_start_time( uint32_t slot_number )
{
   return fc::time_point_sec( slot_number * GOP_BLOCKCHAIN_BLOCK_INTERVAL_SEC );
}
