...
namespace goopal { namespace blockchain {
    ...
    { try {
        ...
        FC_ASSERT( maximum_share_supply >= 0 && maximum_share_supply <= GOP_BLOCKCHAIN_MAX_SHARES ,"Invalid max supply");
        ...
        FC_ASSERT( market_fee <= GOP_BLOCKCHAIN_MAX_UIA_MARKET_FEE ,"Invalid market fee");
