...
namespace goopal { namespace net {
    namespace detail {
        class ChainServerImpl {
          public:
            ChainServer* self;

            fc::tcp_server _server_socket;
            std::shared_ptr<goopal::blockchain::ChainDatabase> _chain_db;
            ...
            ChainServerImpl(std::shared_ptr<goopal::blockchain::ChainDatabase> chain_ptr, uint16_t port)
              : _chain_db(chain_ptr),
...
goopal::net::ChainServer::ChainServer(std::shared_ptr<goopal::blockchain::ChainDatabase> chain_ptr, uint16_t port)
  : my(new detail::ChainServerImpl(chain_ptr, port))
{
    my->self = this;
}
...
uint16_t goopal::net::ChainServer::get_listening_port()
{
