...
static_assert((int)goopal::net::block_message_type == (int)goopal::client::block_message_type, "enum values don't match");
static_assert((int)goopal::net::trx_message_type == (int)goopal::client::trx_message_type, "enum values don't match");
